...
#  $myFile = "//lan/bufkit_data/"."$myModel"."_"."$myStation".".buf";
  $myFile = "/local/ckarsten/bufkit/nam/metdat/bufkit_temp/"."$myModel"."_"."$myStation".".buf";
  open(BUFIN,$myFile) or goto GETSTATION ; 
    if     ($myModel eq "namm" or $myModel eq "etam" or $myModel eq "etaw" or $myModel eq "nam" or $myModel eq "nmm" or $myModel eq "arw" or $myModel eq "ruc") { ReadEtaBufkit() }
